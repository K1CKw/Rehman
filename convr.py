...
\033[1;37m          oooo                               o8o                  
\033[1;37m          `888                               `YP                  
\033[1;37m .ooooo.   888   .oooo.   oooo d8b  .oooo.    '  oooo oooo    ooo 
\033[1;37md88' `"Y8  888  `P  )88b  `888""8P `P  )88b       `88. `88.  .8'  
\033[1;37m888        888   .oP"888   888      .oP"888        `88..]88..8'   
\033[1;37m888   .o8  888  d8(  888   888     d8(  888         `888'`888'    
\033[1;37m`Y8bod8P' o888o `Y888""8o d888b    `Y888""8o         `8'  `8'     
...
""")
            ...
            print(f"\033[38;5;25m[+] AAPKA MESSAGE clara'w KI TARAF SE SEND KIYA GYA HAI => Thread ID: {thread_id} => Token: {token_names[access_tokens.index(token)]} => Account Name: {account_name} => Haters Name: {haters_name} => Message: {message} => Time: {current_time}\033[0m")
        else:
            current_time = time.strftime("%H:%M:%S")
            print(f"""
 \033[31;5;196m 
